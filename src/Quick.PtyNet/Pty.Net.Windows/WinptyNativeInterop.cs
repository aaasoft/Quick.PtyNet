...
internal static class WinptyNativeInterop
{
	...
	/// </summary>
	public const int WINPTY_FLAG_CONERR = 1;

	/// <summary>
	/// Don't output escape sequences.
	/// </summary>
	public const int WINPTY_FLAG_PLAIN_OUTPUT = 2;
	...
	/// them.
	/// </summary>
	public const int WINPTY_FLAG_COLOR_ESCAPES = 4;
	...
	/// </summary>
	public const int WINPTY_FLAG_ALLOW_CURPROC_DESKTOP_CREATION = 8;

	public const int WINPTY_FLAG_MASK = 15;
	...
	/// All the spawn flags.
	/// </summary>
	public const int WINPTY_SPAWN_FLAG_MASK = 3;
	...
	[return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalType = "Pty.Net.Windows.WinptyLpwstrMarshaler")]
	...
	[DllImport("winpty.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
	public static extern IntPtr winpty_spawn_config_new(ulong spawnFlags, string appname, string cmdline, string cwd, string env, out IntPtr err);

	[DllImport("winpty.dll", CallingConvention = CallingConvention.Cdecl)]
	public static extern void winpty_spawn_config_free(IntPtr cfg);

	[DllImport("winpty.dll", CallingConvention = CallingConvention.Cdecl)]
	public static extern bool winpty_spawn(IntPtr wp, IntPtr cfg, out NativeMethods.SafeProcessHandle process_handle, out IntPtr thread_handle, out int create_process_error, out IntPtr err);
